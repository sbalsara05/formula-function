...
const DRIVER_REGISTRY: Partial<Record<Series, Record<string, DriverBundle>>> = {
  f1: {
    ...
    lindblad:    { driver: lindblad,    stats: lindbladStats,    eras: lindbladEras,    signature: lindbladSignature,    reelSlides: lindbladReelSlides,    scoutingReport: lindbladScoutingReport },
...
const DRIVER_IMAGE_MAP: Record<string, string> = {
  // Current grid — F1.com 2026 cutouts (self-hosted)
  max_verstappen:     '/images/drivers/verstappen-f1-portrait-2026.webp',
  hamilton:           '/images/drivers/hamilton-f1-portrait-2026.webp',
  leclerc:            '/images/drivers/leclerc-f1-portrait-2026.webp',
  norris:             '/images/drivers/norris-f1-portrait-2026.webp',
  piastri:            '/images/drivers/piastri-f1-portrait-2026.webp',
  alonso:             '/images/drivers/alonso-f1-portrait-2026.webp',
  russell:            '/images/drivers/russell-f1-portrait-2026.webp',
  sainz:              '/images/drivers/sainz-f1-portrait-2026.webp',
  bottas:             '/images/drivers/bottas-f1-portrait-2026.webp',
  bearman:            '/images/drivers/bearman-f1-portrait-2026.webp',
  hulkenberg:         '/images/drivers/hulkenberg-f1-portrait-2026.webp',
  albon:              '/images/drivers/albon-f1-portrait-2026.webp',
  gasly:              '/images/drivers/gasly-f1-portrait-2026.webp',
  stroll:             '/images/drivers/stroll-f1-portrait-2026.webp',
  ocon:               '/images/drivers/ocon-f1-portrait-2026.webp',
  antonelli:          '/images/drivers/antonelli-f1-portrait-2026.webp',
  hadjar:             '/images/drivers/hadjar-f1-portrait-2026.webp',
  colapinto:          '/images/drivers/colapinto-f1-portrait-2026.webp',
  lawson:             '/images/drivers/lawson-f1-portrait-2026.webp',
  bortoleto:          '/images/drivers/bortoleto-f1-portrait-2026.webp',
  perez:              '/images/drivers/perez-f1-portrait-2026.webp',
  arvid_lindblad:     '/images/drivers/lindblad-f1-portrait-2026.webp',
  lindblad:           '/images/drivers/lindblad-f1-portrait-2026.webp',
  // Nearby / recent (no 2026 F1.com cutout)
